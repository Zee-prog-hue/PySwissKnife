...
def genrate_qr(data: str, file_path: str = "qr_code.png", box_size: int = 10, border: int = 5):
    """
...
if __name__ == "__main__":
    ...
    genrate_qr(user_data, file_path=input("Enter the file path to save the QR code (default: generated_qr_code.png): ") or "generated_qr_code.png")